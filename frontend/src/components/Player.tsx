...
import { GrChapterAdd, GrChapterNext, GrChapterPrevious } from 'react-icons/gr'
    ...
    <div>
      {
        song && <div className="h-[10%] bg-black flex justify-between items-center text-white px-4">
          <div className="lg:flex items-center gap-4">
            <img src={song.thumbnail ? song.thumbnail : "/download.jpg"} 
            className='w-12'
            alt="" />
          ...
          <div className="flex flex-col items-center gap-1 m-auto">
            ...
            <div className="w-full items-center flex font-thin text-green-400">
              <input type="range" min={"0"} max={"100"} className='progress-bar w-[120px] md:w-[300px]' 
          ...
          <div className="flex items-center">
            <input type="range" className='w-16 md:w-32' 
             min={"0"} max={"100"}
             step={"0.01"}
             value={volume * 100}
