  ...
  return (
    <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
      ...
      <div className="bg-[#121212] h-[85%] rounded mt-2">
        ...
        <div className="p-4 m-2 bg-[#121212] rounded font-semibold flex-col items-start gap-1 pl-4 mt-4">
        ...
        {user && user.role ==="admin" && <button className="px-4 py-1.5 bg-white text-black text-[15px] rounded-full mt-4 cursor-pointer " onClick={()=>navigate("/admin/dashboard")}>
          Admin Dashboard
        </button>}
      </div>
    </div>
