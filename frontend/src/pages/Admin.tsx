  ...
  return (
    <div className="min-h-screen bg-[#212121] text-white p-8">
              ...
              <div className="bg-[#181818] p-4 rounded-lg shadow-md" key={i}>
                {
                  ...
                  (
                    <div className="flex flex-co justify-center items-center gap-2">
                      ...
                      disabled={btnLoading}
                      >{btnLoading?"Please Wait...":"Add Thumbnail"}</button>
                    </div>
      ...
      <div className="mt-8">
        ...
        <div className="flex flex-wrap justify-center md:justify-start gap-4 items-stretch">
          {songs?.map((e, i) => {
            return (
              <div
                className="bg-[#181818] p-4 rounded-lg shadow-md w-64 flex flex-col justify-between"
                key={i}
              >
                {/* Image / Upload Section */}
                <div className="w-full h-52 flex items-center justify-center bg-[#282828] rounded mb-4 overflow-hidden">
                  {e.thumbnail ? (
                    <img
                      src={e.thumbnail}
                    ...
                    <div className="flex flex-col justify-center items-center gap-2 p-2 text-center">
                      ...
                      />
                      <button
                        className="auth-btn text-sm py-1 px-2 bg-blue-600 rounded"
                        style={{ width: "120px" }}
                        disabled={btnLoading}
                ...
                <div className="flex-grow">
                  <h4 className="text-lg font-bold truncate">{e.title}</h4>
